...
export const recipientRemittanceMethodService = {
  async getRecipientRemittanceMethods(params: GetRecipientRemittanceMethodsParams): Promise<RecipientRemittanceMethod[]> {
    const queryParams = new URLSearchParams({
      recipient_id: params.recipient_id.toString(),
    });

    const res = await fetch(`${API_URLS.recipientRemittanceMethods.get()}?${queryParams}`, {
      method: 'GET',
      headers: getHeaders(),
    });
  ...
  async getRecipientRemittanceMethodById(id: number): Promise<RecipientRemittanceMethod> {
  ...
  async createRecipientRemittanceMethod(data: CreateRecipientRemittanceMethodRequest): Promise<RecipientRemittanceMethod> {
  ...
  async updateRecipientRemittanceMethod(id: number, data: UpdateRecipientRemittanceMethodRequest): Promise<RecipientRemittanceMethod> {
