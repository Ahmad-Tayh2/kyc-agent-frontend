...
const AddPaymentMethodModal: React.FC<AddPaymentMethodModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"remittance" | "payout">("remittance");
  ...
  const { data: remittanceMethodsData = [] } = useRemittanceMethodsAvailability(rmCountryFilter);
  ...
  const payoutLocationsData = React.useMemo(() => {
    ...
    const allData = payoutLocationsInfiniteData.pages.flatMap((page) => page.data || []);
    return { data: allData };
  ...
  const handleVerifyAccount = async () => {
    ...
    try {
      ...
      const response = await verifyAccountMutation.mutateAsync(verificationRequest);
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      {/* Backdrop */}
      <div className="fixed inset-0 bg-black/15 bg-opacity-50" onClick={handleClose} />
                    ...
                    <>
                      <div className="flex gap-2 items-end">
                        ...
                        <ActionButton
                          ...
                          buttonProps={{
                            disabled:
                              !phoneNumber || !accountNamePrefix || !accountIdPrefix || isVerifying,
                  ...
                  {hasValidator && verificationStatus === "failed" && (
                    <div className="p-3 bg-red-50 border border-red-200 rounded">
                      <p className="text-red-800 text-sm">
                        ❌ <strong>Verification Failed:</strong> Please check your details and try
                        again.
                      </p>
                    </div>
                  )}
                  ...
                  {!hasValidator && (
                    <div className="p-3 bg-yellow-50 border border-yellow-200 rounded">
                      <p className="text-yellow-800 text-sm">
                        ⚠️ <strong>No Validator Available:</strong> You are adding this information
            ...
            <>
              ...
              <div className="space-y-2 mb-6">
                ...
                <SearchableSelect
                  ...
                  onChange={(value) => setSelectedPayoutId(parseInt(value.toString()))}
                  placeholder={
        ...
        <div className="flex justify-end space-x-2 p-4 border-t bg-gray-50">
          ...
          <Button
            ...
            disabled={
              isSubmitting ||
              (activeTab === "remittance" &&
                (!selectedRmId || (hasValidator && verificationStatus !== "verified"))) ||
