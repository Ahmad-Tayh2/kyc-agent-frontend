 ...
 */
export const showPaymentLoading = (_message: string): void => {
 ...
 */
export const showSuccessMessage = (_message: string): void => {
 ...
 */
export const showErrorMessage = (_message: string): void => {
  // Implementation can be enhanced with toast notifications
};
 ...
 */
export const showInfoMessage = (_message: string): void => {
  // Implementation can be enhanced with toast notifications
};
...
export const openWorldpayIframe = (
  ...
  try {
    ...
    const options = {
      ...
      flowCallback: (_result: { page: string }) => {
        // Flow callback for tracking payment page changes
      },
    };
